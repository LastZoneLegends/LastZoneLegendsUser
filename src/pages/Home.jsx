...
export default function Home() {
  ...
  return (
    ...
    <div
      ...
      className="aspect-square h-32 bg-gradient-to-br from-blue-500/20 to-purple-500/20 
    ...
    <div
      ...
      className="aspect-square h-32 bg-gradient-to-br from-green-500/20 to-cyan-500/20 
                 backdrop-blur-md border border-white/10 
                 rounded-2xl flex flex-col items-center justify-center 
                 cursor-pointer hover:scale-105 
    ...
    <div
      ...
      className="aspect-square h-32 bg-gradient-to-br from-pink-500/20 to-purple-500/20 
                 backdrop-blur-md border border-white/10 
                 rounded-2xl flex flex-col items-center justify-center 
                 cursor-pointer hover:scale-105 
